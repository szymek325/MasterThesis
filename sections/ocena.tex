...
\subsection{Wpływ parametrów na czas trwania przygotowania danych uczących}
\begin{figure}[H]
	\centering
...
\subsection{Wpływ parametrów na czas trwania treningu}
\begin{figure}[H]
	\centering
...
\subsection{Wpływ parametrów na rozmiar modelu sieci}
\begin{figure}[H]
	\centering
