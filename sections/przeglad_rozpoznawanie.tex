Na rynku dostępna jest znaczna ilość rozwiązań darmowych jak i płatnych, pozwalających na analizę obrazu w celu detekcji i rozpoznania twarzy. W tym rozdziale porównano najciekawsze ze znalezionych solucji.
\begin{table}[H]
	\centering
	\caption{Parametry czujnika}
	\begin{tabular}{|c|c|c|c|c|}
  		\hline 
  		\bfseries & \bfseries OpenCv & \bfseries Azure CS & \bfseries AWS Rekognition & \bfseries Google \\
  		\hline
  		\bfseries Detekcja twarzy &\\
  		\hline
  		\bfseries Identyfikacja twarzy &\\
  		\hline
  		\bfseries Rozpoznawanie emocji &\\
  		\hline
  		\bfseries SDK &\\
  		\hline
  		\bfseries API &\\
...
Rozwiązania zaimplementowane w tej pracy oraz dodatkowo AWS Rekognition zostały szerzej opisany w kolejnych punktach.
